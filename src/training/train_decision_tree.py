...
from src.config import PROCESSED_DATA_DIR, ARTIFACTS_DIR, IMAGES_DIR, DT_PARAMS
...
def run_training():
    ...
    # 4. Evaluate
    evaluate_model(model, X_test, y_test, "Decision Tree", IMAGES_DIR)
    
    # 5. Save Model
    save_path = os.path.join(ARTIFACTS_DIR, 'decision_tree_model.pkl')
